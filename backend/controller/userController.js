...
const updateUserProfile = catchAsyncError(async (req, res, next) => {
  ...
  if (req.body.avatar !== "") {
    ...
    const userId = user.avatar.public_id;
    await cloudinary.v2.uploader.destroy(userId);
    const myCloud = await cloudinary.v2.uploader.upload(req.body.avatar, {
      folder: "avatars",
      width: 500,
      crop: "scale",
    ...
    console.log(
      "🚀 ~ file: userController.js:172 ~ updateUserProfile ~ newuser",
      newuser
    );
  }
